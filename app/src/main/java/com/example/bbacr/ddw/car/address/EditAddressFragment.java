...
public class EditAddressFragment extends BaseFragment {
    ...
    protected void setData() {
        super.setData();
        mEtShouhuoName.setText(mArguments.getString("name"));
        mEtPhoneAddress.setText(mArguments.getString("phone"));
        mEtAddressPlace.setText(mArguments.getString("city"));
        mEtDetailAddress.setText(mArguments.getString("detail"));
        mLocation = mArguments.getString("location");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.app_title_action:
                editUserAddress(mEtAddressPlace.getText().toString(), mLocation, String.valueOf(ifDefault), mEtShouhuoName.getText().toString(), mEtPhoneAddress.getText().toString(), mEtDetailAddress.getText().toString(),mArguments.getString("addressId"));
                break;
...
//                    provinces = province;
     ...
     * @param detail    添加收货地址
     */
    private void editUserAddress(String city, String location, String ifDefault, final String name, String phone, String detail,String addressId) {
        ...
        HttpHelper.getInstance().post(Url.editUserAddress, hashMap, new RawResponseHandler() {
            ...
            public void onSuccess(int statusCode, String response) {
                LogUtils.d("editUserAddress" + response);
