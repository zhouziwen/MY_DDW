 ...
 * 好评
 */
public class GoodEvaluateFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_good_evaluate, container, false);
    ...
    private void getCommentsList(String goodsId){
        ...
        hashMap.put("commentsPropertyValue", "2");
