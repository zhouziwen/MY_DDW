 ...
 * 差评
 */
public class BadEvaluateFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bad_evaluate, container, false);
    ...
    private void getCommentsList(String goodsId){
        ...
        hashMap.put("commentsPropertyValue", "4");
