 ...
 * 中评
 */
public class CertreEvaluateFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_certre_evaluate, container, false);
    ...
    private void getCommentsList(String goodsId){
        ...
        hashMap.put("commentsPropertyValue", "3");
