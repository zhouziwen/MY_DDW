...
public class NoUseCouponFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_no_use_coupon, container, false);
    ...
    protected void initView(View view) {
        super.initView(view);
        mAdapter = new RcvCommonAdapter<MyCard.DatasBean.DataBean>(getContext(),R.layout.my_coupon_item) {
            @Override
            ...
            public void setListener(SuperViewHolder holder, View view) {
                holder.setOnClickListener(R.id.use);
            }
            @Override
