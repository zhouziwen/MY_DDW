...
import com.example.bbacr.ddw.okthhp.body.ProgressRequestBody;
import com.example.bbacr.ddw.okthhp.body.ResponseProgressBody;
import com.example.bbacr.ddw.okthhp.response.DownloadResponseHandler;
import com.example.bbacr.ddw.okthhp.response.GsonResponseHandler;
import com.example.bbacr.ddw.okthhp.response.IResponseHandler;
import com.example.bbacr.ddw.okthhp.response.JsonResponseHandler;
        ...
        public void onResponse(Call call, final Response response) throws IOException {
            if(response.isSuccessful()) {
                ...
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        mResponseHandler.onFailure(0, "请求失败=" + response.code());
                    }
                });
            }
        }
