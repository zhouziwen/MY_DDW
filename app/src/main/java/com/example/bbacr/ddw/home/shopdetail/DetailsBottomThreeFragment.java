 ...
 *
 */
public class DetailsBottomThreeFragment extends BaseFragment {
    @Bind(R.id.webView)
    WebView mWebView;
    public DetailsBottomThreeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_details_bottom_three, container, false);
    ...
    public void eventBus(PortalDetails.DatasBean card) {
        if (card!=null) {
            Document doc= Jsoup.parse(card.getSafeguard());
