 ...
 * 待付款
 */
public class PayWaitOrderFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pay_wait_order, container, false);
            ...
            public void setData(View view) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        cancelOrder(id, cancelReasonValue);
    ...
    /**
     * @param shopOrderId
     * @param cancelReasonValue 取消整个订单
     */
    private void cancelOrder(int shopOrderId, int cancelReasonValue) {
        startLoadingDialog();
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("token", PreferenceManager.instance().getToken());
        hashMap.put("purchaseOrderId", String.valueOf(shopOrderId));
        hashMap.put("cancelReasonValue", String.valueOf(cancelReasonValue));
        HttpHelper.getInstance().post(Url.cancelOrder, hashMap, new RawResponseHandler() {
            @Override
            public void onSuccess(int statusCode, String response) {
                LogUtils.d("cancelOrder" + response);
                closeLoadingDialog();
