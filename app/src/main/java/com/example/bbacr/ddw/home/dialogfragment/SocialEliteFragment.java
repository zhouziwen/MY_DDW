 ...
 * 社会人士
 */
public class SocialEliteFragment extends BaseFragment {
    ...
    @Bind(R.id.society_manage)
    TextView mManage;

    public SocialEliteFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_social_elite, container, false);
