...
public class AppLoading {
    ...
    protected void initView(BaseActivity activity) {
        initLayout(activity);
        mTextView = (TextView) mLoadingLayout.findViewById(R.id.tipTextView);
        mLoadingImg = (ImageView) mLoadingLayout.findViewById(R.id.progressBar1);
    ...
    private void initLayout(Activity activity) {
        ...
        mLoadingLayout = LayoutInflater.from(activity).inflate(R.layout.dialog_loading, decorView, false);
